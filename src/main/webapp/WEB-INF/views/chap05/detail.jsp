            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <c:if test="${empty login}">
                        <a href="/members/sign-in">댓글은 로그인 후 작성 해주세요 !!</a>
                    </c:if>
...
<script>
    ...
    // 서버에서 실시간으로 비동기 통신을 해서 JSON 을 받아오는 함수
    ...
    function makePageButtonClickEvent(){
        ...
        $pageUl.onclick = e => {
            ...
            // 이벤트 타겟이 a 링크가 아닌경우 href 속성을 못 가져올 수 있으니 타겟 제한하기
    ...
    function makeReplyRemoveClickEvent(){
        ...
        $replyData.onclick = e =>{
            e.preventDefault(); // a태그 링크 이동 기능 중지
